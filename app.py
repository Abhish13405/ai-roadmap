...
if not API_KEY:
    logger.error(
        "GROQ_API_KEY not set. Make sure .env exists and load_dotenv() runs from the project root."
    )
        ...
        try:
            ...
            chat_completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"Create a comprehensive learning roadmap for: {interest}",
                    },
                ],
                temperature=0.7,
                max_tokens=1500,
            ...
            return jsonify(
                {"roadmap": roadmap, "filename": filename, "model_used": model}
            )
